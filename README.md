...
will also could look at deformation of a real object to reccomend modifications to geometry or material choice with user preferences as the standard (action at certain frets, limits on neck size, etc...)
